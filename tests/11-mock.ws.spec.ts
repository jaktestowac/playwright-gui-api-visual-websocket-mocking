  ...
  test.beforeEach(async ({ page }) => {
    await page.routeWebSocket('', (ws) => {
      ...
      ws.onMessage((message) => {
        ...
        messageJson.message = `${messageJson.message} This is a part of mocked data! 🔥`;
        server.send(JSON.stringify(messageJson));
      });
      ...
      server.onMessage((message) => {
        ...
        const messageJson = JSON.parse(message as string);
        messageJson.message = `${messageJson.message} Even more data from the server! 🟩`;
